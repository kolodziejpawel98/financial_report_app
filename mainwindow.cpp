...
QPoint MainWindow::drawExpensesLabels(QWidget *labelsContainer, QLabel *labelsContainerHeader, int numOfExpenses, const std::vector<std::string> &prices, QPoint movingPoints)
{
    labelsContainerHeader->move(movingPoints.x(), movingPoints.y() + 20);
    labelsContainer->move(movingPoints.x(), movingPoints.y() + 40);
    std::cout << "x: " << movingPoints.x() << " y: " << movingPoints.y() << std::endl;
